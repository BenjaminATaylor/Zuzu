setwd("/Users/benjamin/Repositories/Zuzu/work/c5/cbd7b1c7e36c0109c2bff8a91b63be/")
...
deseq.full = get(load("dds_deg.RData"))
...
if("false" == "true"){
  svc.table = read.csv("0", row.names = 1)
...
save(deseq.poorfits,file = "deseq_poorfits.RData")
